...
const Navbar = () => {
  ...
  return (
    <nav className="rounded-[20px] shadow-[20px] sticky top-0 left-0 w-72 h-screen bg-custom-blue p-4 flex flex-col justify-between items-center border-t-[5px] border-b-[5px] border-l-[5px] z-1">
