...
<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  {/* Modal Content */}
  <div className="border fixed justify-center top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-2xl w-1/3">
    ...
    <div className="flex justify-end space-x-4">
      ...
      <button
        ...
        className="w-32 r-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700"
      >
        Save
      </button>
    </div>
